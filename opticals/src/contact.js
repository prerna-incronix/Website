    ...
    <div className="contact-us-main-div">
      ...
      <div className="footer-contact">
        ...
        < FaPhoneAlt className="icon" />
            ...
            <br />
            <div >    
            <ImAddressBook className="icon" style={{ fontSize: '2em' }} />
            <p>Address: main street 123</p>
            </div>
            </div>
          <div className="lottie-animation" style={{alignItems:'center', padding:'-50px'}}>
          <Lottie animationData={animationData} style={{width: '350px', height:'340px', zIndex:'1', alignItems:'center', padding:'30px' }} />
          </div>
      </div>
